...
enum libssh_benchmarks {
    ...
    BENCHMARK_SFTP_FT_UPLOAD,
    BENCHMARK_SFTP_FT_DOWNLOAD,
    BENCHMARK_SFTP_FT_REMOTE_COPY,
    BENCHMARK_NUMBER
};
...
int benchmarks_async_sftp_aio_up(ssh_session session, struct argument_s *args,
    float *bps);
int benchmarks_sftp_ft_up(ssh_session session, struct argument_s *args,
    float *bps);
int benchmarks_sftp_ft_down(ssh_session session, struct argument_s *args,
    float *bps);
int benchmarks_sftp_ft_remote_copy(ssh_session session, struct argument_s *args,
    float *);
#endif /* BENCHMARKS_H_ */
