...
static void torture_algorithms_ecdh_sntrup761x25519_sha512_openssh_com(void **state) {
    struct torture_state *s = *state;
    ...
    test_algorithm(s->ssh.session, "sntrup761x25519-sha512@openssh.com", NULL/*cipher*/, NULL/*hmac*/);
}
